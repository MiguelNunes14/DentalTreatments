            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <img src="<?php echo route('Images/Dentição Permanente.png'); ?>" usemap="#image-map">
                        ...
                        <map name="image-map">
                            <area target="" class="Dente" alt="3º Molar Sup. Dto. | 18" title="3º Molar Sup. Dto. | 18"  denteId="18" coords="97,244,84,237,80,245,78,261,85,266,97,273,113,269,116,250" shape="poly">
